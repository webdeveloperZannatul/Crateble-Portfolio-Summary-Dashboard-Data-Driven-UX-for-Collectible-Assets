! function(t, e) {
    "object" == typeof exports && "undefined" != typeof module ? e(exports) : "function" == typeof define && define.amd ? define(["exports"], e) : e((t = "undefined" != typeof globalThis ? globalThis : t || self).domFactory = {})
}(this, (function(t) {
    "use strict";
    ...
    var Pe, Te = Object.setPrototypeOf || ("__proto__" in {} ? function() {
            var t, e = !1,
                n = {};
            try {
    ...
    var Fe = Object.create || function(t, e) {
            var n;
            return null !== t ? (Me.prototype = A(t), n = new Me, Me.prototype = null, n[Le] = t) : n = ke(), void 0 === e ? n : Ne(n, e)
        },
        Ue = "\t\n\v\f\r                　\u2028\u2029\ufeff",
        $e = "[" + Ue + "]",
        Ge = RegExp("^" + $e + $e + "*"),
    ...
    if (Ct(Xe, !Ye(" 0o1") || !Ye("0b1") || Ye("+0x1"))) {
        for (var tn, en = function(t) {
                var e = arguments.length < 1 ? 0 : t,
                    n = this;
                return n instanceof en && (Je ? i((function() {
                    Ze.valueOf.call(n)
                })) : p(n) != Xe) ? Ie(new Ye(Qe(e)), n, en) : Qe(e)
            }, nn = a ? We(Ye) : "MAX_VALUE,MIN_VALUE,NaN,NEGATIVE_INFINITY,POSITIVE_INFINITY,EPSILON,isFinite,isInteger,isNaN,isSafeInteger,MAX_SAFE_INTEGER,MIN_SAFE_INTEGER,parseFloat,parseInt,isInteger".split(","), rn = 0; nn.length > rn; rn++) _(Ye, tn = nn[rn]) && !_(en, tn) && qe(en, tn, Ke(Ye, tn));
    ...
    xn("split", 2, (function(t, e, n) {
        ...
        return r = "c" == "abbc".split(/(b)*/)[1] || 4 != "test".split(/(?:)/, -1).length || 2 != "ab".split(/(?:ab)*/).length || 4 != ".".split(/(.?)(.?)/).length || ".".split(/()()/).length > 1 || "".split(/.?/).length ? function(t, n) {
            var r, o, i = String(v(this)),
                a = void 0 === n ? Ln : n >>> 0;
            if (0 === a) return [];
            if (void 0 === t) return [i];
            if (!y(r = t) || !(void 0 !== (o = r[In]) ? o : "RegExp" == p(r))) return e.call(i, t, a);
            for (var c, u, f, l = [], s = (t.ignoreCase ? "i" : "") + (t.multiline ? "m" : "") + (t.unicode ? "u" : "") + (t.sticky ? "y" : ""), d = 0, h = new RegExp(t.source, s + "g");
                (c = bn.call(h, i)) && !((u = h.lastIndex) > d && (l.push(i.slice(d, c.index)), c.length > 1 && c.index < i.length && Nn.apply(l, c.slice(1)), f = c[0].length, d = u, l.length >= a));) h.lastIndex === c.index && h.lastIndex++;
            ...
            for (var d = 0, h = 0, v = []; h < c.length;) {
                s.lastIndex = Mn ? h : 0;
                var g, y = Tn(s, Mn ? c : c.slice(h));
                if (null === y || (g = Rn(st(s.lastIndex + (Mn ? 0 : h)), c.length)) === d) h = Pn(c, h, f);
                else {
                        ...
                        t.__watchers__[e].push(n), u && function() {
                            ...
                            var u = function(n) {
                                ...
                                if (0 !== r && t[e] && (c(t[e]) || a(t[e])) && !t[e].__watchers__)
                                    for (var i = 0; i < t.__watchers__[e].length; i++) g(t[e], t.__watchers__[e][i], void 0 === r ? r : r - 1);
    ...
    var cr, ur, fr, lr = function(t) {
        ...
        sr = wt.f,
        pr = {}.toString,
        dr = "object" == typeof window && window && Object.getOwnPropertyNames ? Object.getOwnPropertyNames(window) : [],
        hr = {
            f: function(t) {
    ...
    (kt || (rt((jr = function() {
        ...
        stringify: function(t, e, n) {
            ...
            if (r = e, (y(e) || void 0 !== t) && !Gr(t)) return Dt(e) || (e = function(t, e) {
                if ("function" == typeof r && (e = r.call(this, t, e)), !Gr(e)) return e
            }), o[1] = e, Ar.apply(null, o)
        }
    });
    jr.prototype[Er] || I(jr.prototype, Er, jr.prototype.valueOf), ur = wr, (cr = jr) && !_(cr = fr ? cr : cr.prototype, br) && yr(cr, br, {
        configurable: !0,
        value: ur
    }), q[_r] = !0, Rt({
        target: "Object",
    ...
    Rt({
        ...
        splice: function(t, e) {
            ...
            if (o.length = r, n < r) {
                ...
                for (i = f - r; i > l; i--) c = i + n - 1, (a = i + r - 1) in u ? u[c] = u[a] : delete u[c];
    ...
    var bo = Object.assign,
        ...
        _o = !bo || i((function() {
            ...
            for (var n = Mt(t), r = arguments.length, o = 1, i = Et.f, c = f.f; r > o;)
                for (var u, l = h(arguments[o++]), s = i ? Ce(l).concat(i(l)) : Ce(l), p = s.length, d = 0; p > d;) u = s[d++], a && !c.call(l, u) || (n[u] = l[u]);
            return n
        } : bo;
    Rt({
        target: "Object",
